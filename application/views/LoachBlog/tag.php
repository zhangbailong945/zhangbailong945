...
<head>
    ...
    <title><?php if(!empty($tagword)){echo '标签:'.$tagword;}else{echo 'LoachBlog 个人笔记|标签';}?></title>
    <meta name="description" content="LoachBlog 个人笔记|标签'">
    <meta name="<?php if(!empty($tagword)){echo '标签,'.$tagword;}else{echo 'LoachBlog 个人笔记|标签';}?>">
              ...
              <main class="col-md-8 main-content" id="search">
	            <?php 
                   if(!empty($tagword))
                   {
                   	  ...
                   	  echo "共搜索到 <font color='#e67e22'>".$total."</font> 篇关于 <span class='tagword'><font color='#e67e22'>".$tagword."</font></span> 的笔记";
                   	  echo "</div>";
                   	  echo "</div>";
                   }
	            ?>
                ...
                <?php 
                  foreach ($list as $li)
                  {
                  	 ...
                  	 $article_title=str_ireplace($tagword,'<span class="tagword"><font color="#e67e22">'.$tagword.'</font></span>',$li->article_title);
                  	 $article_text=trim((mb_substr(strip_tags($li->article_text),0,300,'utf-8')));
                  	 $article_text=str_ireplace($tagword,'<span class="tagword"><font color="#e67e22">'.$tagword.'</font></span>',$article_text);
