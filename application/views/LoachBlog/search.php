...
<head>
    ...
    <title><?php if(!empty($keyword)){echo '搜索:'.$keyword;}else{echo 'LoachBlog 个人笔记|搜索';}?></title>
    <meta name="description" content="">
    <meta name="keywords" content="><?php if(!empty($keyword)){echo '搜索,'.$keyword;}else{echo 'LoachBlog 个人笔记|搜索';}?>">
              ...
              <main class="col-md-8 main-content" id="search">
	            <?php 
                   if(!empty($keyword))
                   {
                   	  ...
                   	  echo "共搜索到 <font color='#e67e22'>".$total."</font> 篇关于 <span class='tagword'><font color='#e67e22'>".$keyword."</font></span> 的笔记";
                   	  echo "</div>";
                   	  echo "</div>";
                   }
	            ?>
                ...
                <?php 
                  foreach ($list as $li)
                  {
                  	 ...
                  	 $article_title=str_ireplace($keyword,'<span class="tagword"><font color="#e67e22">'.$keyword.'</font></span>',$li->article_title);
                  	 $article_text=trim((mb_substr(strip_tags($li->article_text),0,300,'utf-8')));
                  	 $article_text=str_ireplace($keyword,'<span class="tagword"><font color="#e67e22">'.$keyword.'</font></span>',$article_text);
