...
<head>
  ...
  <link rel="stylesheet" href="<?php echo $AdminLTESrc_Path;?>/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css">
    ...
    <link rel="stylesheet" href="<?php echo $AdminLTESrc_Path;?>/plugins/datatables/dataTables.bootstrap.css">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="<?php echo $submit_Path;?>administrator/Users/index"><i class="fa fa-circle-o"></i>用户列表</a></li>
          </ul>
        </li>
                ...
                <tbody>
                  ...
                  <?php 
                    ...
                    foreach ($list as $li)
                    {
                    	echo '<tr>';
                    	echo '<td>'.$li["id"].'</td>';
                    	echo '<td>'.$li["username"].'</td>';
                    	echo '<td>'.$li["useremail"].'</td>';
                    	echo '<td>'.$li["userip"].'</td>';
                    	echo '</tr>';
                    }
                  ?>
...
<!-- DataTables -->
<script src="<?php echo $AdminLTESrc_Path;?>/plugins/datatables/jquery.dataTables.min.js"></script>
<script src="<?php echo $AdminLTESrc_Path;?>/plugins/datatables/dataTables.bootstrap.min.js"></script>
<!-- SlimScroll -->
