    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo $submit_Path;?>administrator/Article/index"><i class="fa fa-circle-o"></i>笔记列表</a></li>
            <li><a href="<?php echo $submit_Path;?>administrator/Article/articleadd"><i class="fa fa-circle-o"></i>撰写笔记</a></li>
          </ul>
        </li>
    ...
    <section id="list" class="content">
        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-body">
              ...
              <table id="articleslist" cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered table-hover">
                <thead>
      ...
      <!-- /.row -->
		...
		<div class="modal fade" id="myModal" tabindex="-1" role="dialog" 
		   aria-labelledby="myModalLabel" width="100%" aria-hidden="true">
		         ...
		         <div class="modal-body col-lg-8 col-lg-offset-2">
		             <form class="form-horizontal" id="articletypeaddForm">
                        ...
                        <div class="form-group">
                                ...
                                <div class="col-lg-5">
                                    <input type="text" class="form-control" id="article_type_id" name="article_type_id" />
                                </div>
                        </div>
...
<script>
  ...
  $(function(){
	$('#articletypeaddForm').bootstrapValidator({
            ...
            fields: {  
                ...
                validators: {
                    ...
                    regexp: {
                        regexp: /^[a-zA-Z0-9_\.]+$/,
                        message: '笔记类型名称只能以大小写字母，数字和滴下划线组成。'
                    }
                }
            },
            article_type_slug:{  
                ...
                validators: {
                    ...
                    regexp: {
                        regexp: /^[a-zA-Z0-9_\.]+$/,
                        message: '笔记类型缩略只能以大小写字母，数字和滴下划线组成。'
                    }
                }
            }
	...
	$('#articleslist tbody').on('change', 'input[type="checkbox"]', function(){
  ...
  */
  function initTable()
  {
		var table=$('#articleslist').DataTable({
		       'ajax':'<?php echo $submit_Path;?>administrator/Article/ajaxArticleList',
		       'columnDefs': [{
		           'targets':0,
		           'searchable': false,
		           'orderable': false,
		       ...
		       'columns':[
		                  ...
		                  {'data':'article_slug'},
		                  {'data':'article_created'},
		                  {
		                      "data": "article_id",
		                      "fnCreatedCell": function (nTd, sData, oData, iRow, iCol) {		                          
		                          $(nTd).html("<a href='javascript:void(0);' " +
		                          "onclick='_editFun(\"" + oData.article_id + "\",\"" + oData.article_title + "\",\"" + oData.article_text + "\",\"" + oData.article_type_name + "\")'>编辑</a>&nbsp;&nbsp;")
